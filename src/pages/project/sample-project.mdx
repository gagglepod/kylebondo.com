...
description: "Markdown Styling for Project Posts"
...
```astro
<ProjectImage src={Dog} alt="Beagle Dog by Jules D. on Unsplash" />

<ProjectImage src={Portrait} alt="Beagle Dog by Jules D. on Unsplash" />
```
